...
void ElementSceny::usun(Cukierek *&c,int val, Cukierek *&c1, int val1, Cukierek *&c2, int val2, Cukierek *&c3, int val3, Cukierek *&c4, int val4, int ile)
{
    if(ile==5){
        ...
        cuksy.insert(cuksy.begin()+val1,new Cukierek(pos1.x,pos1.y));

        delete *(cuksy.begin()+val);
        cuksy.erase(cuksy.begin()+val);
        cuksy.insert(cuksy.begin()+val,new Cukierek(pos.x,pos.y));

        delete *(cuksy.begin()+val2);
        cuksy.erase(cuksy.begin()+val2);
        cuksy.insert(cuksy.begin()+val2,new Cukierek(pos2.x,pos2.y));

        delete *(cuksy.begin()+val3);
        cuksy.erase(cuksy.begin()+val3);
        cuksy.insert(cuksy.begin()+val3,new Cukierek(pos3.x,pos3.y));

        delete *(cuksy.begin()+val4);
        cuksy.erase(cuksy.begin()+val4);
        cuksy.insert(cuksy.begin()+val4,new Cukierek(pos4.x,pos4.y));
...
vector<Cukierek *> ElementSceny::stworz_cuksy()
{
    for(int j=0;j<10;j++){
        for(int i=0;i<10;i++){
            cuksy.emplace_back(new Cukierek(154+i*50,104+j*50));
        }
    }
    return cuksy;
}
